...
public class RationalAgent {
    ...
    private static int def_b_1 = 66;   //two markers
    private static int def_c_1 = 22489;  //three markers
    private static int def_d_1 = 141;    //intersections of one marker
    private static int def_e_1 = 6403;   //intersections of two markers
    private static int def_f_1 = 14470;  //intersections of three markers
    private static int def_g_1 = 19899; //number of forks
    private static int def_h_1 = 83651; //number of forced wins


    public static final int[] weights_1_static = {
    ...
    public RationalAgent(Player player, int[] weights_1){
        this.player = player;
        this.plies = 3;
